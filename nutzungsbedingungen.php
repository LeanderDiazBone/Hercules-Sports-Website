  ...
  <html>
    ...
    <body style="width:100%;height:auto;margin:0;background-color:#3d567c" onscroll="LOAD_SP();" onload="LOAD_ALL();LOAD_SP();RESIZE();" onresize="RESIZE()">
      ...
      <div style="width:100%;text-align:center">
        ...
        <p>Wenn Sie unsere Website nutzen, sollen im Verhältnis zwischen Nutzer und Betreiber dieser Seite die folgenden Nutzungsbedingungen verbindlich vereinbart werden.</p>
        <p>Informationen, die vom Betreiber dieser Internetseite oder Dritten für Nutzer bereitgehalten werden, sind marken- und/oder urheberrechtlich geschützt. Es ist nicht gestattet, die Website im Ganzen oder in Teilen herunterzuladen, zu vervielfältigen, zu verbreiten oder auf anderen Internetseiten und unter anderen Domains zu veröffentlichen. Gestattet ist die technisch bedingte Vervielfältigung zum Zwecke des Browsings, soweit mit dem Browsing keine wirtschaftlichen Zwecke verfolgt werden. Gestattet ist auch die Vervielfältigung für den eigenen Gebrauch.</p>
        <p>Gern können Sie einen Link auf diese Website setzen, soweit er der Querreferenz dient. Es ist nicht gestattet, die Internetseite in einem Frame darzustellen. Wir behalten uns vor, im Einzelfall die Gestattung einer Verlinkung zu widerrufen.</p>
        <p>Wir haften für die Inhalte dieser Internetseite gemäß den gesetzlichen Bestimmungen. Für die Richtigkeit und Vollständigkeit der auf der Internetseite befindlichen Informationen kann keine Gewähr übernommen werden.</p>
        <p>Wird im Rahmen dieser Internetseite auf Webseiten Dritter verwiesen, erklären wir, dass wir uns die hinter dem Verweis oder dem Link liegenden Inhalte nicht zu Eigen machen. Die Inhalte begründen keine Verantwortung für die auf anderen Internetseiten bereit gehaltenen Daten und Informationen. Wir weisen darauf hin, dass wir keinen Einfluss auf die hinter einem Link liegenden Inhalte haben. Daher können wir auch nicht für rechtswidrige, fehlerhafte oder unvollständige Inhalte haften, die Dritte im Internet bereithalten. Auch für Schäden, die aufgrund der Nutzung von einem hinter dem Link liegenden Inhalt verursacht worden sind, können wir nicht haften.</p>
        <p>Die Nutzung des Internets erfolgt auf eigene Gefahr des jeweiligen Nutzers. Wir haften nicht für technisch bedingten Ausfall des Internets oder für den Zugang des Internets.</p>
        <p>Sofern zwischen dem Nutzer und uns ein Vertragsverhältnis zustande kommt, findet für dieses Vertragsverhältnis deutsches Recht unter Ausschluss des UN-Kaufrechts Anwendung. Dies gilt nicht, soweit zwingende Verbraucherschutzvorschriften des Landes, in dem der Vertragspartner seinen gewöhnlichen Aufenthalt hat, anzuwenden sind. Außerdem sind ggf. abweichende Regelungen bei der Verletzung von Immaterialgüterrechten im Rahmen der Rechtswahl zu beachten.</p>
        <p style="margin-bottom:0;padding-bottom:50px;">Wenn ein Vertragspartner Kaufmann, juristische Person des öffentlichen Rechts oder öffentlich rechtliches Sondervermögen ist, ist Gerichtsstand der Sitz unseres Unternehmens.</p>
    </div>
  </body>
  </html>
