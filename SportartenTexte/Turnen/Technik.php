...
<body onload="" onscroll="LOAD_TX();document.getElementById('Unterlinks').style.top= window.innerHeight * 2 + 'px'" onresize="LOAD_TX();RESIZE()" style="width:100%;overflow-x:hidden;margin:0">
	...
	?>
		...
		<div id="Pfad"><span>Du befindest dich hier: </span><br> <a href="Allgemein.php">Turnen</a> - Technik</div>
		<div id="TEXT">
      <h3>Grundtechniken im Turnen:</h3>
      <h3>Bodenturnen</h3>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/6T2AkcZN0J8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <h3>Reck</h3>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/ZwxVqMPQDRo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
