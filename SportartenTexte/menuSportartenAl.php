...
<div id="Searchbar" style="margin-top:5px" onmouseleave="resetSuche();document.getElementById('Searchbar').style.transitionDelay = '0.5s'" onmouseover="document.getElementById('Searchbar').style.transitionDelay = '0s'">
